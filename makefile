...
itr1:
	...
	sed -i "s/^const GAME_FOLDER_NAME =.*/const GAME_FOLDER_NAME = 'IntoTheRadius';/" index.js
...
itr2:
	...
	sed -i "s/^const GAME_FOLDER_NAME =.*/const GAME_FOLDER_NAME = 'IntoTheRadius2';/" index.js
